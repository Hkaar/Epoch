  ...
  <main class="flex min-h-screen flex-col">
    <section class="grid flex-1 grid-cols-2 items-center">
      ...
      <form action="{{ route('login.post') }}" method="POST" class="flex flex-col gap-3.5">
        ...
        <div class="max-w-lg">
          <label for="username-label" class="mb-2 block text-sm font-medium dark:text-white">Username or Email</label>
        ...
        <p class="tracking-wide text-gray-400">
          ...
          <a class="text-blue-400 underline" href="{{ route('register') }}">
            register
          </a>
          now!
        </p>
